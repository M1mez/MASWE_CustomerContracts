...
using AllCustomers_Status_Consumer.Models;
using Newtonsoft.Json;
using Newtonsoft.Json.Serialization;

namespace AllCustomers_Status_Consumer
{
    public class EventsApiClient : IDisposable
    {
        ...
        public List<Customer> AllCustomersStatus()
        {
            var request = new HttpRequestMessage(HttpMethod.Get, "allCustomersStatus");
